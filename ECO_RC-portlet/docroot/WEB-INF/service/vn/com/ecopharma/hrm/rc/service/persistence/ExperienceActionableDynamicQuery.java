 ...
 * @generated
 */
public abstract class ExperienceActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ExperienceActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ExperienceLocalServiceUtil.getService());
		setClass(Experience.class);

		setClassLoader(vn.com.ecopharma.hrm.rc.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("experienceId");
	}
}