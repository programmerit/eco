...
/**
 * Provides the local service utility for CandidateActionHistory. This utility wraps
 * {@link vn.com.ecopharma.hrm.rc.service.impl.CandidateActionHistoryLocalServiceImpl} and is the
 ...
 * @see vn.com.ecopharma.hrm.rc.service.impl.CandidateActionHistoryLocalServiceImpl
 * @generated
 */
public class CandidateActionHistoryLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.com.ecopharma.hrm.rc.service.impl.CandidateActionHistoryLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory addCandidateActionHistory(
		vn.com.ecopharma.hrm.rc.model.CandidateActionHistory candidateActionHistory)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addCandidateActionHistory(candidateActionHistory);
	}
	...
	*/
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory createCandidateActionHistory(
		long candidateActionHistoryId) {
		return getService()
				   .createCandidateActionHistory(candidateActionHistoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory deleteCandidateActionHistory(
		long candidateActionHistoryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
				   .deleteCandidateActionHistory(candidateActionHistoryId);
	}
	...
	*/
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory deleteCandidateActionHistory(
		vn.com.ecopharma.hrm.rc.model.CandidateActionHistory candidateActionHistory)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteCandidateActionHistory(candidateActionHistory);
	}
	...
	*/
	...
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory fetchCandidateActionHistory(
		long candidateActionHistoryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchCandidateActionHistory(candidateActionHistoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory getCandidateActionHistory(
		long candidateActionHistoryId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getCandidateActionHistory(candidateActionHistoryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.com.ecopharma.hrm.rc.model.CandidateActionHistory> getCandidateActionHistories(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCandidateActionHistories(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getCandidateActionHistoriesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getCandidateActionHistoriesCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory updateCandidateActionHistory(
		vn.com.ecopharma.hrm.rc.model.CandidateActionHistory candidateActionHistory)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateCandidateActionHistory(candidateActionHistory);
	}
	...
	*/
	...
	public static java.util.List<vn.com.ecopharma.hrm.rc.model.CandidateActionHistory> findByCandidateAndActionType(
		...
		return getService().findByCandidateAndActionType(candidateId, actionType);
	}
	...
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory createPrePersistedEntity() {
	...
	public static vn.com.ecopharma.hrm.rc.model.CandidateActionHistory createPrePersistedEntity(
		...
		return getService()
				   .createPrePersistedEntity(candidateId, action, actionType,
			executedBy, description, serviceContext);
	}
	...
	public static CandidateActionHistoryLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CandidateActionHistoryLocalService.class.getName());

			if (invokableLocalService instanceof CandidateActionHistoryLocalService) {
				_service = (CandidateActionHistoryLocalService)invokableLocalService;
			}
			else {
				_service = new CandidateActionHistoryLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(CandidateActionHistoryLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(CandidateActionHistoryLocalService service) {
	}

	private static CandidateActionHistoryLocalService _service;
}