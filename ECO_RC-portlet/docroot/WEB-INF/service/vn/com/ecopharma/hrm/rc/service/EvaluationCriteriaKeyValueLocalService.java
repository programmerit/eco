...
/**
 * Provides the local service interface for EvaluationCriteriaKeyValue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tvt
 * @see EvaluationCriteriaKeyValueLocalServiceUtil
...
public interface EvaluationCriteriaKeyValueLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EvaluationCriteriaKeyValueLocalServiceUtil} to access the evaluation criteria key value local service. Add custom service methods to {@link vn.com.ecopharma.hrm.rc.service.impl.EvaluationCriteriaKeyValueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
