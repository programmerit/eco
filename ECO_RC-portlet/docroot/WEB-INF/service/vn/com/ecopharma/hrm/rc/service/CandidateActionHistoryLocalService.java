...
/**
 * Provides the local service interface for CandidateActionHistory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tvt
 * @see CandidateActionHistoryLocalServiceUtil
...
public interface CandidateActionHistoryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CandidateActionHistoryLocalServiceUtil} to access the candidate action history local service. Add custom service methods to {@link vn.com.ecopharma.hrm.rc.service.impl.CandidateActionHistoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
