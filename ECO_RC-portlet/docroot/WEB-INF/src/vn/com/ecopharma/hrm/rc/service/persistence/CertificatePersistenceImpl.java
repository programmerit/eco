...
import vn.com.ecopharma.hrm.rc.NoSuchCertificateException;
import vn.com.ecopharma.hrm.rc.model.Certificate;
import vn.com.ecopharma.hrm.rc.model.impl.CertificateImpl;
import vn.com.ecopharma.hrm.rc.model.impl.CertificateModelImpl;
...
public class CertificatePersistenceImpl extends BasePersistenceImpl<Certificate>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_CLASSNAME = new FinderPath(CertificateModelImpl.ENTITY_CACHE_ENABLED,
			CertificateModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Certificate> findByClassName(String className, int start,
	 ...
	 */
	@Override
	public Certificate findByClassName_First(String className,
		OrderByComparator orderByComparator)
		throws NoSuchCertificateException, SystemException {
		Certificate certificate = fetchByClassName_First(className,
				orderByComparator);
	 ...
	 */
	@Override
	public Certificate fetchByClassName_First(String className,
		OrderByComparator orderByComparator) throws SystemException {
		List<Certificate> list = findByClassName(className, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Certificate findByClassName_Last(String className,
		OrderByComparator orderByComparator)
		throws NoSuchCertificateException, SystemException {
		Certificate certificate = fetchByClassName_Last(className,
				orderByComparator);
	 ...
	 */
	@Override
	public Certificate fetchByClassName_Last(String className,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Certificate> list = findByClassName(className, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Certificate[] findByClassName_PrevAndNext(long certificateId,
		...
		try {
			...
			array[0] = getByClassName_PrevAndNext(session, certificate,
					className, orderByComparator, true);

			array[1] = certificate;

			array[2] = getByClassName_PrevAndNext(session, certificate,
	...
	protected Certificate getByClassName_PrevAndNext(Session session,
		Certificate certificate, String className,
	...
	public void removeByClassName(String className) throws SystemException {
		for (Certificate certificate : findByClassName(className,
	...
	private static final String _FINDER_COLUMN_CLASSNAME_CLASSNAME_1 = "certificate.className IS NULL";
	private static final String _FINDER_COLUMN_CLASSNAME_CLASSNAME_2 = "certificate.className = ?";
	private static final String _FINDER_COLUMN_CLASSNAME_CLASSNAME_3 = "(certificate.className IS NULL OR certificate.className = '')";
	...
	public Certificate updateImpl(
		...
		if (isNew || !CertificateModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((certificateModelImpl.getColumnBitmask() &
				...
				args = new Object[] { certificateModelImpl.getClassName() };
	...
	protected Certificate toUnwrappedModel(Certificate certificate) {
		...
		certificateImpl.setUniversityId(certificate.getUniversityId());
		certificateImpl.setGraduationYear(certificate.getGraduationYear());
		...
		certificateImpl.setCourseTimeFrom(certificate.getCourseTimeFrom());
		certificateImpl.setCourseTimeTo(certificate.getCourseTimeTo());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.vn.com.ecopharma.hrm.rc.model.Certificate")));
