...
import vn.com.ecopharma.hrm.rc.servlet.filter.CustomRequestWrapper;
...
public abstract class PersistStateDataModel<T> extends LazyDataModel<T> {
	 ...
	 *
	 * @param expression
	 *            EL value expression, such as #{var.property}
	...
	private CustomRequestWrapper findCustomRequestWrapper(ServletRequest request) {
