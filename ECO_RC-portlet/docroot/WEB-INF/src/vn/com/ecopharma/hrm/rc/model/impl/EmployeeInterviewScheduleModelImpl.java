...
import vn.com.ecopharma.hrm.rc.model.EmployeeInterviewScheduleModel;
import vn.com.ecopharma.hrm.rc.model.EmployeeInterviewScheduleSoap;
...
/**
 * The base model implementation for the EmployeeInterviewSchedule service. Represents a row in the &quot;eco_rcp_EmployeeInterviewSchedule&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.com.ecopharma.hrm.rc.model.EmployeeInterviewScheduleModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link EmployeeInterviewScheduleImpl}.
 * </p>
 *
 * @author tvt
 * @see EmployeeInterviewScheduleImpl
 * @see vn.com.ecopharma.hrm.rc.model.EmployeeInterviewSchedule
 * @see vn.com.ecopharma.hrm.rc.model.EmployeeInterviewScheduleModel
 * @generated
 */
@JSON(strict = true)
public class EmployeeInterviewScheduleModelImpl extends BaseModelImpl<EmployeeInterviewSchedule>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a employee interview schedule model instance should use the {@link vn.com.ecopharma.hrm.rc.model.EmployeeInterviewSchedule} interface instead.
	 */
	public static final String TABLE_NAME = "eco_rcp_EmployeeInterviewSchedule";
	...
	public static final String TABLE_SQL_CREATE = "create table eco_rcp_EmployeeInterviewSchedule (employeeInterviewScheduleId LONG not null primary key,employeeId LONG,interviewScheduleId LONG,note VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table eco_rcp_EmployeeInterviewSchedule";
	public static final String ORDER_BY_JPQL = " ORDER BY employeeInterviewSchedule.employeeInterviewScheduleId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY eco_rcp_EmployeeInterviewSchedule.employeeInterviewScheduleId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.com.ecopharma.hrm.rc.model.EmployeeInterviewSchedule"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.com.ecopharma.hrm.rc.model.EmployeeInterviewSchedule"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.com.ecopharma.hrm.rc.model.EmployeeInterviewSchedule"),
			true);
	public static long INTERVIEWSCHEDULEID_COLUMN_BITMASK = 1L;
	public static long EMPLOYEEINTERVIEWSCHEDULEID_COLUMN_BITMASK = 2L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.com.ecopharma.hrm.rc.model.EmployeeInterviewSchedule"));
	...
	public Object clone() {
		...
		employeeInterviewScheduleImpl.setUserName(getUserName());
	...
	public CacheModel<EmployeeInterviewSchedule> toCacheModel() {
		...
		employeeInterviewScheduleCacheModel.userName = getUserName();

		String userName = employeeInterviewScheduleCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			employeeInterviewScheduleCacheModel.userName = null;
		}
