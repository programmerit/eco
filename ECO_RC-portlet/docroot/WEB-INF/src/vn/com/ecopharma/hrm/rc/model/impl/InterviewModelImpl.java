...
import vn.com.ecopharma.hrm.rc.model.InterviewModel;
import vn.com.ecopharma.hrm.rc.model.InterviewSoap;
...
/**
 * The base model implementation for the Interview service. Represents a row in the &quot;eco_rcp_Interview&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.com.ecopharma.hrm.rc.model.InterviewModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link InterviewImpl}.
 * </p>
 *
 * @author tvt
 * @see InterviewImpl
 * @see vn.com.ecopharma.hrm.rc.model.Interview
 * @see vn.com.ecopharma.hrm.rc.model.InterviewModel
 * @generated
 */
@JSON(strict = true)
public class InterviewModelImpl extends BaseModelImpl<Interview>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a interview model instance should use the {@link vn.com.ecopharma.hrm.rc.model.Interview} interface instead.
	 */
	public static final String TABLE_NAME = "eco_rcp_Interview";
	...
	public static final String TABLE_SQL_CREATE = "create table eco_rcp_Interview (interviewId LONG not null primary key,name VARCHAR(75) null,titlesId LONG,deleted BOOLEAN,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table eco_rcp_Interview";
	public static final String ORDER_BY_JPQL = " ORDER BY interview.interviewId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY eco_rcp_Interview.interviewId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.com.ecopharma.hrm.rc.model.Interview"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.com.ecopharma.hrm.rc.model.Interview"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.com.ecopharma.hrm.rc.model.Interview"));
	...
	public Object clone() {
		...
		interviewImpl.setTitlesId(getTitlesId());
		interviewImpl.setDeleted(getDeleted());
	...
	public CacheModel<Interview> toCacheModel() {
		...
		interviewCacheModel.titlesId = getTitlesId();

		interviewCacheModel.deleted = getDeleted();
