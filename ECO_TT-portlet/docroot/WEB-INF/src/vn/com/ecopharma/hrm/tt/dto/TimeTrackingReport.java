...
public class TimeTrackingReport {
	...
	public TimeTrackingReport(Document document) {
		this.empId = Long.valueOf(document.getField(TimeTrackingField.EMP_ID)
				.getValue());
		this.fullName = document.getField(TimeTrackingField.FULLNAME)
				.getValue();
		this.empCode = document.getField(TimeTrackingField.EMP_CODE).getValue();
