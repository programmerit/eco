...
public final class SourceTimeItem implements Serializable {
	...
	private int OT_TimeHours; // NOSONAR
	...
	private static Date fixDate(Date srcDate, Date destDate) {
		if (srcDate == null)
			return null;
	...
	public int getOT_TimeHours() { // NOSONAR
		return OT_TimeHours;
	}

	public void setOT_TimeHours(int OT_TimeHours) { // NOSONAR
		this.OT_TimeHours = OT_TimeHours;
	}
