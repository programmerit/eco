...
/**
 * Provides the local service interface for TimeTracking. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tvt
 * @see TimeTrackingLocalServiceUtil
...
public interface TimeTrackingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TimeTrackingLocalServiceUtil} to access the time tracking local service. Add custom service methods to {@link vn.com.ecopharma.hrm.tt.service.impl.TimeTrackingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
