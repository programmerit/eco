...
public class StaffLocalServiceWrapper implements StaffLocalService,
	...
	*/
	...
	public void indexAllStaffs() {
		_staffLocalService.indexAllStaffs();
	}

	@Override
	public void indexSomeStaffs() {
		_staffLocalService.indexSomeStaffs();
	}
	...
	public void removeAllStaffIndexes(
		...
		long companyId) {
		_staffLocalService.removeAllStaffIndexes(searchContext, companyId);
	}

	@Override
	public void completelyRemoveAllStaff(long companyId) {
		_staffLocalService.completelyRemoveAllStaff(companyId);
	}
	...
	public int countAllIndexedStaffDocuments(
		com.liferay.portal.kernel.search.SearchContext searchContext,
		long companyId) {
		return _staffLocalService.countAllIndexedStaffDocuments(searchContext,
			companyId);
	}
	...
	public int countAllUnDeletedIndexedStaffDocuments(
		...
		return _staffLocalService.countAllUnDeletedIndexedStaffDocuments(searchContext,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllUnDeletedStaffIndexedDocument(
		...
		int end) {
		return _staffLocalService.searchAllUnDeletedStaffIndexedDocument(searchContext,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllUnDeletedStaffIndexedDocument1(
		...
		long companyId, com.liferay.portal.kernel.search.Sort sort, int start,
		int end) {
		return _staffLocalService.searchAllUnDeletedStaffIndexedDocument1(searchContext,
			filterQueries, companyId, sort, start, end);
	}
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllUnDeletedStaffIndexedDocumentWithConditionStaffList(
		...
		int start, int end) {
		return _staffLocalService.searchAllUnDeletedStaffIndexedDocumentWithConditionStaffList(searchContext,
	...
	public int countAllUnDeletedIndexedStaffDocumentWithConditionStaffList(
		...
		long companyId, java.util.List<java.lang.Long> StaffIds,
		boolean isExcluded, com.liferay.portal.kernel.search.Sort sort) {
		return _staffLocalService.countAllUnDeletedIndexedStaffDocumentWithConditionStaffList(searchContext,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllUnDeletedStaffIndexedDocumentByName(
		...
		com.liferay.portal.kernel.search.SearchContext searchContext,
		long companyId) {
		return _staffLocalService.searchAllUnDeletedStaffIndexedDocumentByName(name,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllStaffIndexedDocuments(
		com.liferay.portal.kernel.search.SearchContext searchContext,
		long companyId) {
		return _staffLocalService.searchAllStaffIndexedDocuments(searchContext,
			companyId);
	}
	...
	public java.util.List<vn.com.ecopharma.emp.model.Staff> findAll() {
		return _staffLocalService.findAll();
	}

	@Override
	public java.util.List<vn.com.ecopharma.emp.model.Staff> findAll(int start,
		int end) {
		return _staffLocalService.findAll(start, end);
	}
	...
	public java.util.List<vn.com.ecopharma.emp.model.Staff> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator) {
		return _staffLocalService.findAll(start, end, orderByComparator);
	}
	...
	public java.util.List<vn.com.ecopharma.emp.model.Staff> filterStaffs(
		...
		return _staffLocalService.filterStaffs(globStr, fullName, emp_code,
	...
	public vn.com.ecopharma.emp.model.Staff addStaff1(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _staffLocalService.addStaff1(staff, serviceContext);
	}
	...
	public vn.com.ecopharma.emp.model.Staff addStaff(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _staffLocalService.addStaff(e, autoPassword, password1,
	...
	public vn.com.ecopharma.emp.model.Staff update(
		...
		com.liferay.portal.service.ServiceContext serviceContext) {
		return _staffLocalService.update(Staff, user, titles, level,
	...
	public vn.com.ecopharma.emp.model.Staff createStaff(
		...
		return _staffLocalService.createStaff(StaffCode, titlesId, levelId,
	...
	public com.liferay.portal.kernel.search.Document getIndexedStaff(
		...
		com.liferay.portal.kernel.search.SearchContext searchContext) {
		return _staffLocalService.getIndexedStaff(StaffIdString, searchContext);
	}
	...
	public com.liferay.portal.kernel.search.Document getIndexedStaff(
		long StaffId,
		com.liferay.portal.kernel.search.SearchContext searchContext) {
		return _staffLocalService.getIndexedStaff(StaffId, searchContext);
	}

	@Override
	public vn.com.ecopharma.emp.model.Staff markDeletedStaff(
		vn.com.ecopharma.emp.model.Staff Staff) {
		return _staffLocalService.markDeletedStaff(Staff);
	}

	@Override
	public vn.com.ecopharma.emp.model.Staff markDeletedStaff(long StaffId) {
		return _staffLocalService.markDeletedStaff(StaffId);
	}

	@Override
	public int countAll() {
		return _staffLocalService.countAll();
	}
