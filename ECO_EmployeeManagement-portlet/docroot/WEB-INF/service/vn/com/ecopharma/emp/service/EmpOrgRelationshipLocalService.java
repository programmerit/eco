...
/**
 * Provides the local service interface for EmpOrgRelationship. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tvt
 * @see EmpOrgRelationshipLocalServiceUtil
...
public interface EmpOrgRelationshipLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmpOrgRelationshipLocalServiceUtil} to access the emp org relationship local service. Add custom service methods to {@link vn.com.ecopharma.emp.service.impl.EmpOrgRelationshipLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
