...
/**
 * Provides the local service interface for EmpAnnualLeave. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tvt
 * @see EmpAnnualLeaveLocalServiceUtil
...
public interface EmpAnnualLeaveLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmpAnnualLeaveLocalServiceUtil} to access the emp annual leave local service. Add custom service methods to {@link vn.com.ecopharma.emp.service.impl.EmpAnnualLeaveLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
