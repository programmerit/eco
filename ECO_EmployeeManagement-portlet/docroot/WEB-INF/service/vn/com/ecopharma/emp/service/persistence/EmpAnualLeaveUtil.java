...
/**
 * The persistence utility for the emp anual leave service. This utility wraps {@link EmpAnualLeavePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class EmpAnualLeaveUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(EmpAnualLeave empAnualLeave) {
		getPersistence().clearCache(empAnualLeave);
	}
	 ...
	 */
	public static List<EmpAnualLeave> findWithDynamicQuery(
	 ...
	 */
	public static EmpAnualLeave update(EmpAnualLeave empAnualLeave)
		throws SystemException {
		return getPersistence().update(empAnualLeave);
	}
	...
	public static EmpAnualLeave update(EmpAnualLeave empAnualLeave,
		...
		return getPersistence().update(empAnualLeave, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(empAnualLeave);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(empAnualLeaves);
	}
	...
	*/
	public static vn.com.ecopharma.emp.model.EmpAnualLeave create(
		long empAnualLeaveId) {
		return getPersistence().create(empAnualLeaveId);
	}
	...
	*/
	public static vn.com.ecopharma.emp.model.EmpAnualLeave remove(
		long empAnualLeaveId)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.com.ecopharma.emp.NoSuchEmpAnualLeaveException {
		return getPersistence().remove(empAnualLeaveId);
	}

	public static vn.com.ecopharma.emp.model.EmpAnualLeave updateImpl(
		vn.com.ecopharma.emp.model.EmpAnualLeave empAnualLeave)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(empAnualLeave);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.ecopharma.emp.model.EmpAnualLeave findByPrimaryKey(
		long empAnualLeaveId)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.com.ecopharma.emp.NoSuchEmpAnualLeaveException {
		return getPersistence().findByPrimaryKey(empAnualLeaveId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.ecopharma.emp.model.EmpAnualLeave fetchByPrimaryKey(
		long empAnualLeaveId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(empAnualLeaveId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.com.ecopharma.emp.model.EmpAnualLeave> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static EmpAnualLeavePersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (EmpAnualLeavePersistence)PortletBeanLocatorUtil.locate(vn.com.ecopharma.emp.service.ClpSerializer.getServletContextName(),
					EmpAnualLeavePersistence.class.getName());

			ReferenceRegistry.registerReference(EmpAnualLeaveUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(EmpAnualLeavePersistence persistence) {
	}

	private static EmpAnualLeavePersistence _persistence;
}