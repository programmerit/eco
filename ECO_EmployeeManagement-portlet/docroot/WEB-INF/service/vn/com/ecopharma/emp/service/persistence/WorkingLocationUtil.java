...
/**
 * The persistence utility for the working location service. This utility wraps {@link WorkingLocationPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class WorkingLocationUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(WorkingLocation workingLocation) {
		getPersistence().clearCache(workingLocation);
	}
	 ...
	 */
	public static List<WorkingLocation> findWithDynamicQuery(
	 ...
	 */
	public static WorkingLocation update(WorkingLocation workingLocation)
		throws SystemException {
		return getPersistence().update(workingLocation);
	}
	...
	public static WorkingLocation update(WorkingLocation workingLocation,
		...
		return getPersistence().update(workingLocation, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(workingLocation);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(workingLocations);
	}
	...
	*/
	public static vn.com.ecopharma.emp.model.WorkingLocation create(
		long workingLocationId) {
		return getPersistence().create(workingLocationId);
	}
	...
	*/
	public static vn.com.ecopharma.emp.model.WorkingLocation remove(
		long workingLocationId)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.com.ecopharma.emp.NoSuchWorkingLocationException {
		return getPersistence().remove(workingLocationId);
	}

	public static vn.com.ecopharma.emp.model.WorkingLocation updateImpl(
		vn.com.ecopharma.emp.model.WorkingLocation workingLocation)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(workingLocation);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.ecopharma.emp.model.WorkingLocation findByPrimaryKey(
		long workingLocationId)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.com.ecopharma.emp.NoSuchWorkingLocationException {
		return getPersistence().findByPrimaryKey(workingLocationId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.com.ecopharma.emp.model.WorkingLocation fetchByPrimaryKey(
		long workingLocationId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(workingLocationId);
	}
	...
	*/
	...
	public static WorkingLocationPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (WorkingLocationPersistence)PortletBeanLocatorUtil.locate(vn.com.ecopharma.emp.service.ClpSerializer.getServletContextName(),
					WorkingLocationPersistence.class.getName());

			ReferenceRegistry.registerReference(WorkingLocationUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(WorkingLocationPersistence persistence) {
	}

	private static WorkingLocationPersistence _persistence;
}