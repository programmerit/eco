...
/**
 * Provides a wrapper for {@link EcoEmployeeLocalService}.
 *
 * @author tvt
 * @see EcoEmployeeLocalService
 * @generated
 */
public class EcoEmployeeLocalServiceWrapper implements EcoEmployeeLocalService,
	ServiceWrapper<EcoEmployeeLocalService> {
	public EcoEmployeeLocalServiceWrapper(
		EcoEmployeeLocalService ecoEmployeeLocalService) {
		_ecoEmployeeLocalService = ecoEmployeeLocalService;
	}
	...
	*/
	...
	public vn.com.ecopharma.emp.model.EcoEmployee addEcoEmployee(
		...
		return _ecoEmployeeLocalService.addEcoEmployee(ecoEmployee);
	}
	...
	*/
	...
	public vn.com.ecopharma.emp.model.EcoEmployee createEcoEmployee(
		long ecoEmployeeId) {
		return _ecoEmployeeLocalService.createEcoEmployee(ecoEmployeeId);
	}
	...
	*/
	...
	public vn.com.ecopharma.emp.model.EcoEmployee deleteEcoEmployee(
		...
		return _ecoEmployeeLocalService.deleteEcoEmployee(ecoEmployeeId);
	}
	...
	*/
	...
	public vn.com.ecopharma.emp.model.EcoEmployee deleteEcoEmployee(
		vn.com.ecopharma.emp.model.EcoEmployee ecoEmployee)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.deleteEcoEmployee(ecoEmployee);
	}

	@Override
	public com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery() {
		return _ecoEmployeeLocalService.dynamicQuery();
	}
	...
	*/
	...
	public java.util.List dynamicQuery(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.dynamicQuery(dynamicQuery);
	}
	...
	*/
	...
	public java.util.List dynamicQuery(
		...
		return _ecoEmployeeLocalService.dynamicQuery(dynamicQuery, start, end);
	}
	...
	*/
	...
	public long dynamicQueryCount(
		com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.dynamicQueryCount(dynamicQuery);
	}
	...
	*/
	...
	public vn.com.ecopharma.emp.model.EcoEmployee fetchEcoEmployee(
		long ecoEmployeeId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.fetchEcoEmployee(ecoEmployeeId);
	}
	...
	*/
	...
	public vn.com.ecopharma.emp.model.EcoEmployee getEcoEmployee(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.getEcoEmployee(ecoEmployeeId);
	}
	...
	public com.liferay.portal.model.PersistedModel getPersistedModel(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.getPersistedModel(primaryKeyObj);
	}
	...
	*/
	...
	public java.util.List<vn.com.ecopharma.emp.model.EcoEmployee> getEcoEmployees(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.getEcoEmployees(start, end);
	}
	...
	*/
	...
	public int getEcoEmployeesCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.getEcoEmployeesCount();
	}
	...
	*/
	...
	public vn.com.ecopharma.emp.model.EcoEmployee updateEcoEmployee(
		vn.com.ecopharma.emp.model.EcoEmployee ecoEmployee)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.updateEcoEmployee(ecoEmployee);
	}
	...
	*/
	...
	public java.lang.String getBeanIdentifier() {
		return _ecoEmployeeLocalService.getBeanIdentifier();
	}
	...
	*/
	...
	public void setBeanIdentifier(java.lang.String beanIdentifier) {
		_ecoEmployeeLocalService.setBeanIdentifier(beanIdentifier);
	}
	...
	public java.lang.Object invokeMethod(java.lang.String name,
		...
		return _ecoEmployeeLocalService.invokeMethod(name, parameterTypes,
			arguments);
	}

	@Override
	public void indexAllEmployees() {
		_ecoEmployeeLocalService.indexAllEmployees();
	}
	...
	public void removeAllEmployeeIndexes(
		...
		long companyId) {
		_ecoEmployeeLocalService.removeAllEmployeeIndexes(searchContext,
			companyId);
	}
	...
	public int countAllIndexedEmployeeDocuments(
		com.liferay.portal.kernel.search.SearchContext searchContext,
		long companyId) {
		return _ecoEmployeeLocalService.countAllIndexedEmployeeDocuments(searchContext,
			companyId);
	}
	...
	public int countAllUnDeletedIndexedEmployeeDocuments(
		...
		return _ecoEmployeeLocalService.countAllUnDeletedIndexedEmployeeDocuments(searchContext,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllUnDeletedEmployeeIndexedDocument(
		...
		int end) {
		return _ecoEmployeeLocalService.searchAllUnDeletedEmployeeIndexedDocument(searchContext,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllUnDeletedEmployeeIndexedDocumentWithConditionEmployeeList(
		...
		int start, int end) {
		return _ecoEmployeeLocalService.searchAllUnDeletedEmployeeIndexedDocumentWithConditionEmployeeList(searchContext,
	...
	public int countAllUnDeletedIndexedEmployeeDocumentWithConditionEmployeeList(
		...
		long companyId, java.util.List<java.lang.Long> employeeIds,
		boolean isExcluded, com.liferay.portal.kernel.search.Sort sort) {
		return _ecoEmployeeLocalService.countAllUnDeletedIndexedEmployeeDocumentWithConditionEmployeeList(searchContext,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllUnDeletedEmployeeIndexedDocumentByName(
		...
		com.liferay.portal.kernel.search.SearchContext searchContext,
		long companyId) {
		return _ecoEmployeeLocalService.searchAllUnDeletedEmployeeIndexedDocumentByName(name,
	...
	public java.util.List<com.liferay.portal.kernel.search.Document> searchAllEmployeeIndexedDocuments(
		com.liferay.portal.kernel.search.SearchContext searchContext,
		long companyId) {
		return _ecoEmployeeLocalService.searchAllEmployeeIndexedDocuments(searchContext,
			companyId);
	}
	...
	public java.util.List<vn.com.ecopharma.emp.model.EcoEmployee> findAll() {
		return _ecoEmployeeLocalService.findAll();
	}

	@Override
	public java.util.List<vn.com.ecopharma.emp.model.EcoEmployee> findAll(
		int start, int end) {
		return _ecoEmployeeLocalService.findAll(start, end);
	}
	...
	public java.util.List<vn.com.ecopharma.emp.model.EcoEmployee> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator) {
		return _ecoEmployeeLocalService.findAll(start, end, orderByComparator);
	}
	...
	public java.util.List<vn.com.ecopharma.emp.model.EcoEmployee> filterEmployees(
		...
		return _ecoEmployeeLocalService.filterEmployees(globStr, fullName,
	...
	public vn.com.ecopharma.emp.model.EcoEmployee addEmployee(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.addEmployee(e, autoPassword, password1,
	...
	public vn.com.ecopharma.emp.model.EcoEmployee update(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _ecoEmployeeLocalService.update(EcoEmployee, user, subUnit,
			titles, level, university, addressesMap, serviceContext);
	}
	...
	public vn.com.ecopharma.emp.model.EcoEmployee createEcoEmployee(
		...
		return _ecoEmployeeLocalService.createEcoEmployee(emp_code, jTitlesId,
			titlesId, levelId, promoted_date, subUnitId, joined_date,
			laborContractSignedDate, laborContractExpiredDate,
			laborContractType, dob, gender, placeOfBirth, education,
			education_specialize, universityId, marrital_status,
			identityCard_no, issued_date, issued_place, contactNumber,
			companyEmailAddress, taxCode, insurranceCode, bankNo, bankBranchName);
	}
	...
	public com.liferay.portal.kernel.search.Document getIndexedEmployee(
		...
		com.liferay.portal.kernel.search.SearchContext searchContext) {
		return _ecoEmployeeLocalService.getIndexedEmployee(employeeIdString,
			searchContext);
	}
	...
	public com.liferay.portal.kernel.search.Document getIndexedEmployee(
		long ecoEmployeeId,
		com.liferay.portal.kernel.search.SearchContext searchContext) {
		return _ecoEmployeeLocalService.getIndexedEmployee(ecoEmployeeId,
			searchContext);
	}
	...
	public vn.com.ecopharma.emp.model.EcoEmployee markDeletedEmployee(
		vn.com.ecopharma.emp.model.EcoEmployee EcoEmployee) {
		return _ecoEmployeeLocalService.markDeletedEmployee(EcoEmployee);
	}

	@Override
	public vn.com.ecopharma.emp.model.EcoEmployee markDeletedEmployee(
		long ecoEmployeeId) {
		return _ecoEmployeeLocalService.markDeletedEmployee(ecoEmployeeId);
	}

	@Override
	public int countAll() {
		return _ecoEmployeeLocalService.countAll();
	}

	/**
	 * @deprecated As of 6.1.0, replaced by {@link #getWrappedService}
	 */
	public EcoEmployeeLocalService getWrappedEcoEmployeeLocalService() {
		return _ecoEmployeeLocalService;
	}

	/**
	 * @deprecated As of 6.1.0, replaced by {@link #setWrappedService}
	 */
	public void setWrappedEcoEmployeeLocalService(
		EcoEmployeeLocalService ecoEmployeeLocalService) {
		_ecoEmployeeLocalService = ecoEmployeeLocalService;
	}

	@Override
	public EcoEmployeeLocalService getWrappedService() {
		return _ecoEmployeeLocalService;
	}
	...
	private EcoEmployeeLocalService _ecoEmployeeLocalService;
}