...
/**
 * This class is used by SOAP remote services, specifically {@link vn.com.ecopharma.emp.service.http.EcoEmployeeServiceSoap}.
 *
 * @author tvt
 * @see vn.com.ecopharma.emp.service.http.EcoEmployeeServiceSoap
 * @generated
 */
public class EcoEmployeeSoap implements Serializable {
	public static EcoEmployeeSoap toSoapModel(EcoEmployee model) {
		EcoEmployeeSoap soapModel = new EcoEmployeeSoap();

		soapModel.setEcoEmployeeId(model.getEcoEmployeeId());
	...
	public static EcoEmployeeSoap[] toSoapModels(EcoEmployee[] models) {
		EcoEmployeeSoap[] soapModels = new EcoEmployeeSoap[models.length];
	...
	public static EcoEmployeeSoap[][] toSoapModels(EcoEmployee[][] models) {
		EcoEmployeeSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new EcoEmployeeSoap[models.length][models[0].length];
		}
		else {
			soapModels = new EcoEmployeeSoap[0][0];
		}
	...
	public static EcoEmployeeSoap[] toSoapModels(List<EcoEmployee> models) {
		List<EcoEmployeeSoap> soapModels = new ArrayList<EcoEmployeeSoap>(models.size());

		for (EcoEmployee model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new EcoEmployeeSoap[soapModels.size()]);
	}

	public EcoEmployeeSoap() {
	}
