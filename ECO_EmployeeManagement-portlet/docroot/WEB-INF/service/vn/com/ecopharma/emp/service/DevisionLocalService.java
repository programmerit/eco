...
/**
 * Provides the local service interface for Devision. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tvt
 * @see DevisionLocalServiceUtil
...
public interface DevisionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DevisionLocalServiceUtil} to access the devision local service. Add custom service methods to {@link vn.com.ecopharma.emp.service.impl.DevisionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
