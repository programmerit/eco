...
import vn.com.ecopharma.emp.service.LevelLocalService;
...
/**
 * Provides the base implementation for the level local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.ecopharma.emp.service.impl.LevelLocalServiceImpl}.
 * </p>
 *
 * @author tvt
 ...
 * @generated
 */
public abstract class LevelLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements LevelLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.ecopharma.emp.service.LevelLocalServiceUtil} to access the level local service.
	 */
	...
	@Override
	public Level addLevel(Level level) throws SystemException {
		level.setNew(true);

		return levelPersistence.update(level);
	}
	 ...
	 */
	@Override
	public Level createLevel(long levelId) {
		return levelPersistence.create(levelId);
	}
	...
	@Override
	public Level deleteLevel(long levelId)
		throws PortalException, SystemException {
		return levelPersistence.remove(levelId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Level deleteLevel(Level level) throws SystemException {
		return levelPersistence.remove(level);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Level.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return levelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return levelPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return levelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return levelPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Level fetchLevel(long levelId) throws SystemException {
		return levelPersistence.fetchByPrimaryKey(levelId);
	}
	 ...
	 */
	@Override
	public Level getLevel(long levelId) throws PortalException, SystemException {
		return levelPersistence.findByPrimaryKey(levelId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return levelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Level> getLevels(int start, int end) throws SystemException {
		return levelPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getLevelsCount() throws SystemException {
		return levelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Level updateLevel(Level level) throws SystemException {
		return levelPersistence.update(level);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.com.ecopharma.emp.model.Level",
			levelLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = levelPersistence.getDataSource();
	...
	private LevelLocalServiceClpInvoker _clpInvoker = new LevelLocalServiceClpInvoker();
}