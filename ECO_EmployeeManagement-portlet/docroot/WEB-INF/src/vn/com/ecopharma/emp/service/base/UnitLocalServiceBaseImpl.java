...
import vn.com.ecopharma.emp.service.UnitLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.ecopharma.emp.service.impl.UnitLocalServiceImpl}.
 * </p>
 *
 * @author tvt
...
public abstract class UnitLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UnitLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.ecopharma.emp.service.UnitLocalServiceUtil} to access the unit local service.
	 */
	...
	@Override
	public Unit addUnit(Unit unit) throws SystemException {
		unit.setNew(true);
	...
	@Override
	public Unit deleteUnit(long unitId) throws PortalException, SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Unit deleteUnit(Unit unit) throws SystemException {
	...
	@Override
	public Unit fetchUnit(long unitId) throws SystemException {
	 ...
	 */
	@Override
	public Unit getUnit(long unitId) throws PortalException, SystemException {
	 ...
	 */
	@Override
	public List<Unit> getUnits(int start, int end) throws SystemException {
	 ...
	 */
	@Override
	public int getUnitsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Unit updateUnit(Unit unit) throws SystemException {
		return unitPersistence.update(unit);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.com.ecopharma.emp.model.Unit",
			unitLocalService);
	}
	...
	private UnitLocalServiceClpInvoker _clpInvoker = new UnitLocalServiceClpInvoker();
}