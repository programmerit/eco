...
import vn.com.ecopharma.emp.service.PromotedHistoryLocalService;
...
/**
 * Provides the base implementation for the promoted history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.ecopharma.emp.service.impl.PromotedHistoryLocalServiceImpl}.
 * </p>
 *
 * @author tvt
 ...
 * @generated
 */
public abstract class PromotedHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PromotedHistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.ecopharma.emp.service.PromotedHistoryLocalServiceUtil} to access the promoted history local service.
	 */
	...
	public PromotedHistory addPromotedHistory(PromotedHistory promotedHistory)
		...
		return promotedHistoryPersistence.update(promotedHistory);
	}
	 ...
	 */
	@Override
	public PromotedHistory createPromotedHistory(long promotedHistoryId) {
		return promotedHistoryPersistence.create(promotedHistoryId);
	}
	...
	@Override
	public PromotedHistory deletePromotedHistory(long promotedHistoryId)
		throws PortalException, SystemException {
		return promotedHistoryPersistence.remove(promotedHistoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PromotedHistory deletePromotedHistory(
		PromotedHistory promotedHistory) throws SystemException {
		return promotedHistoryPersistence.remove(promotedHistory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PromotedHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return promotedHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return promotedHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public PromotedHistory fetchPromotedHistory(long promotedHistoryId)
		throws SystemException {
		return promotedHistoryPersistence.fetchByPrimaryKey(promotedHistoryId);
	}
	 ...
	 */
	@Override
	public PromotedHistory getPromotedHistory(long promotedHistoryId)
		throws PortalException, SystemException {
		return promotedHistoryPersistence.findByPrimaryKey(promotedHistoryId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return promotedHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PromotedHistory> getPromotedHistories(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getPromotedHistoriesCount() throws SystemException {
		return promotedHistoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PromotedHistory updatePromotedHistory(
		PromotedHistory promotedHistory) throws SystemException {
		return promotedHistoryPersistence.update(promotedHistory);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.com.ecopharma.emp.model.PromotedHistory",
			promotedHistoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = promotedHistoryPersistence.getDataSource();
	...
	private PromotedHistoryLocalServiceClpInvoker _clpInvoker = new PromotedHistoryLocalServiceClpInvoker();
}