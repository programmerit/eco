...
import vn.com.ecopharma.emp.service.EmpLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.ecopharma.emp.service.impl.EmpLocalServiceImpl}.
 * </p>
 *
 * @author tvt
...
public abstract class EmpLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EmpLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.ecopharma.emp.service.EmpLocalServiceUtil} to access the emp local service.
	 */
	...
	@Override
	public Emp deleteEmp(long empId) throws PortalException, SystemException {
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Emp deleteEmp(Emp emp) throws SystemException {
	...
	@Override
	public Emp fetchEmp(long empId) throws SystemException {
	 ...
	 */
	@Override
	public Emp getEmp(long empId) throws PortalException, SystemException {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.com.ecopharma.emp.model.Emp",
			empLocalService);
	}
