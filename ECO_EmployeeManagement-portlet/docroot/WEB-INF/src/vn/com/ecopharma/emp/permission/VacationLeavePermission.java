...
public class VacationLeavePermission implements Serializable {
	private static final long serialVersionUID = 1L;

	private static final Log LOGGER = LogFactoryUtil
			.getLog(VacationLeavePermission.class);
	...
	public static boolean contains(PermissionChecker permissionChecker,
		...
		try {
			final VacationLeave o = VacationLeaveLocalServiceUtil
					.fetchVacationLeave(id);
			return o != null ? permissionChecker.hasPermission(o.getGroupId(),
					VacationLeave.class.getName(), o.getVacationLeaveId(),
					actionId) : false;
