...
import vn.com.ecopharma.emp.service.DevisionLocalService;
...
/**
 * Provides the base implementation for the devision local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.ecopharma.emp.service.impl.DevisionLocalServiceImpl}.
 * </p>
 *
 * @author tvt
 ...
 * @generated
 */
public abstract class DevisionLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DevisionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.ecopharma.emp.service.DevisionLocalServiceUtil} to access the devision local service.
	 */
	...
	@Override
	public Devision addDevision(Devision devision) throws SystemException {
		devision.setNew(true);

		return devisionPersistence.update(devision);
	}
	 ...
	 */
	@Override
	public Devision createDevision(long devisionId) {
		return devisionPersistence.create(devisionId);
	}
	...
	@Override
	public Devision deleteDevision(long devisionId)
		throws PortalException, SystemException {
		return devisionPersistence.remove(devisionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Devision deleteDevision(Devision devision) throws SystemException {
		return devisionPersistence.remove(devision);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Devision.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return devisionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return devisionPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return devisionPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return devisionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Devision fetchDevision(long devisionId) throws SystemException {
		return devisionPersistence.fetchByPrimaryKey(devisionId);
	}
	 ...
	 */
	@Override
	public Devision getDevision(long devisionId)
		throws PortalException, SystemException {
		return devisionPersistence.findByPrimaryKey(devisionId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return devisionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Devision> getDevisions(int start, int end)
		throws SystemException {
		return devisionPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDevisionsCount() throws SystemException {
		return devisionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Devision updateDevision(Devision devision) throws SystemException {
		return devisionPersistence.update(devision);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.com.ecopharma.emp.model.Devision",
			devisionLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = devisionPersistence.getDataSource();
	...
	private DevisionLocalServiceClpInvoker _clpInvoker = new DevisionLocalServiceClpInvoker();
}