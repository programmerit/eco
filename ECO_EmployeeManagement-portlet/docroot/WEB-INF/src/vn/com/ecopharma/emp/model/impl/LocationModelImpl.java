...
import vn.com.ecopharma.emp.model.LocationModel;
import vn.com.ecopharma.emp.model.LocationSoap;
...
/**
 * The base model implementation for the Location service. Represents a row in the &quot;eco_em_portlet_Location&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link vn.com.ecopharma.emp.model.LocationModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link LocationImpl}.
 * </p>
 *
 * @author tvt
 * @see LocationImpl
 * @see vn.com.ecopharma.emp.model.Location
 * @see vn.com.ecopharma.emp.model.LocationModel
 * @generated
 */
@JSON(strict = true)
public class LocationModelImpl extends BaseModelImpl<Location>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a location model instance should use the {@link vn.com.ecopharma.emp.model.Location} interface instead.
	 */
	public static final String TABLE_NAME = "eco_em_portlet_Location";
	...
	public static final String TABLE_SQL_CREATE = "create table eco_em_portlet_Location (locationId LONG not null primary key,name VARCHAR(75) null,addressId LONG,type_ VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table eco_em_portlet_Location";
	public static final String ORDER_BY_JPQL = " ORDER BY location.locationId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY eco_em_portlet_Location.locationId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.vn.com.ecopharma.emp.model.Location"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.vn.com.ecopharma.emp.model.Location"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.vn.com.ecopharma.emp.model.Location"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.vn.com.ecopharma.emp.model.Location"));
	...
	public Object clone() {
		...
		locationImpl.setAddressId(getAddressId());
	...
	public void resetOriginalValues() {
		...
		locationModelImpl._originalType = locationModelImpl._type;
	...
	public CacheModel<Location> toCacheModel() {
		...
		locationCacheModel.addressId = getAddressId();
