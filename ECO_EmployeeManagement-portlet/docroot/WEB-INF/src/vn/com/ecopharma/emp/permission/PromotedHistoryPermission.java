...
@ManagedBean
public class PromotedHistoryPermission implements Serializable {
	...
	public static boolean contains(PermissionChecker permissionChecker,
		...
		try {
			final PromotedHistory p = PromotedHistoryLocalServiceUtil
					.fetchPromotedHistory(id);
			return p != null ? permissionChecker.hasPermission(p.getGroupId(),
					PromotedHistory.class.getName(), p.getPromotedHistoryId(),
					actionId) : false;
