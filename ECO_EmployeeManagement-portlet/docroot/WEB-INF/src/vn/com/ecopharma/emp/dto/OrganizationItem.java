...
public class OrganizationItem implements Serializable {
	...
	private static final int VI_TITLES_CELL = 4;
	private static final int EN_TITLES_CELL = 5;
	private static final int TITLES_CODE_CELL = 6;
	...
	public OrganizationItem(String devision, String department, String unit,
			String viTitles, String enTitles, String titlesCode) {
	...
	private void bindFieldsFromRow(Row row) {
		...
		System.out.println("devision: " + this.devision + "department: "
				+ this.department + "unit: " + this.unit + "titles: "
				+ this.enTitles);
	}

	private boolean isValidStringCell(Cell cell) {
