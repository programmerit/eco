...
@ManagedBean
public class ResignationHistoryPermission implements Serializable {
	...
	public static boolean contains(PermissionChecker permissionChecker,
		...
		try {
			final ResignationHistory r = ResignationHistoryLocalServiceUtil
					.fetchResignationHistory(id);
			return r != null ? permissionChecker.hasPermission(r.getGroupId(),
					ResignationHistory.class.getName(),
					r.getResignationHistoryId(), actionId) : false;
