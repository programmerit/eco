...
import vn.com.ecopharma.emp.service.UnitGroupLocalService;
...
/**
 * Provides the base implementation for the unit group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.com.ecopharma.emp.service.impl.UnitGroupLocalServiceImpl}.
 * </p>
 *
 * @author tvt
 ...
 * @generated
 */
public abstract class UnitGroupLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UnitGroupLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.com.ecopharma.emp.service.UnitGroupLocalServiceUtil} to access the unit group local service.
	 */
	...
	public UnitGroup addUnitGroup(UnitGroup unitGroup)
		...
		return unitGroupPersistence.update(unitGroup);
	}
	 ...
	 */
	@Override
	public UnitGroup createUnitGroup(long unitGroupId) {
		return unitGroupPersistence.create(unitGroupId);
	}
	...
	@Override
	public UnitGroup deleteUnitGroup(long unitGroupId)
		throws PortalException, SystemException {
		return unitGroupPersistence.remove(unitGroupId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UnitGroup deleteUnitGroup(UnitGroup unitGroup)
		throws SystemException {
		return unitGroupPersistence.remove(unitGroup);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UnitGroup.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return unitGroupPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return unitGroupPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return unitGroupPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UnitGroup fetchUnitGroup(long unitGroupId) throws SystemException {
		return unitGroupPersistence.fetchByPrimaryKey(unitGroupId);
	}
	 ...
	 */
	@Override
	public UnitGroup getUnitGroup(long unitGroupId)
		throws PortalException, SystemException {
		return unitGroupPersistence.findByPrimaryKey(unitGroupId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return unitGroupPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UnitGroup> getUnitGroups(int start, int end)
		throws SystemException {
		return unitGroupPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUnitGroupsCount() throws SystemException {
		return unitGroupPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UnitGroup updateUnitGroup(UnitGroup unitGroup)
		throws SystemException {
		return unitGroupPersistence.update(unitGroup);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.com.ecopharma.emp.model.UnitGroup",
			unitGroupLocalService);
	}
	...
	private UnitGroupLocalServiceClpInvoker _clpInvoker = new UnitGroupLocalServiceClpInvoker();
}