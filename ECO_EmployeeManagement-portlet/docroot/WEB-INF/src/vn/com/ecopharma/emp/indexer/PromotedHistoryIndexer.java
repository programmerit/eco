...
public class PromotedHistoryIndexer extends BaseIndexer {

	private String[] CLASS_NAMES = new String[] { PromotedHistory.class
			.getName() };
	...
	protected Document doGetDocument(Object obj) throws Exception {
		PromotedHistory p = PromotedHistoryLocalServiceUtil
				.fetchPromotedHistory(((PromotedHistory) obj)
